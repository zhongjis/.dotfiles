...
" selectable.
let g:nvim_tree_special_***REMOVED***les = { 'README.md': 1, 'Make***REMOVED***le': 1, 'MAKEFILE': 1 } " List of ***REMOVED***lenames that gets highlighted with NvimTreeSpecialFile
...
nnoremap <F1> :NvimTreeFindFile<CR>
