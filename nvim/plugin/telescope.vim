...
nnoremap <C-p> :lua require('telescope.builtin'***REMOVED***.***REMOVED***nd_***REMOVED***les(***REMOVED***<CR>
...
nnoremap <leader>gm :lua require('telescope'***REMOVED***.extensions.git_worktree.create_git_worktree(***REMOVED***<CR>n
