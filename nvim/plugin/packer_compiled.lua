...
_G.packer_plugins = {
  ...
  ["copilot.vim"] = {
    loaded = true,
    path = "/Users/zshen/.local/share/nvim/site/pack/packer/start/copilot.vim",
  ...
  ["lsp_signature.nvim"] = {
    loaded = true,
    path = "/Users/zshen/.local/share/nvim/site/pack/packer/start/lsp_signature.nvim",
  ...
  ["vim-vsnip-integ"] = {
    loaded = true,
    path = "/Users/zshen/.local/share/nvim/site/pack/packer/start/vim-vsnip-integ",
